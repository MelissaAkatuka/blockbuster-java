            ...
            <div class="wrap">   
                <div class="main-options">
                    <ul class="menu-top">
                        ...
                        <li><a href="${cp}/formularios/exemplar/listagem.jsp">Voltar</a></li>
                    </ul>
                </div>
            </div>
        </header>
        ...
        <section class="section-information fundo">
            <div class="container" style="background:#d9d9d9">
                <div class="row title-section" id="programa-trainee">
                    <h1 class="title form-signin">Excluir Exemplar</h1>
                </div>
                ...
                <form method="post" action="${cp}/processaExemplar">
                    ...
                    <table class="form-signin">
                        ...
                        <tr>
                            <td class="alinharDireita">Mídia Id:</td>
                            <td>${requestScope.exemplar.midia.id}</td>
                        </tr>
                        <tr>
                            <td class="alinharDireita">Mídia Título: </td>
